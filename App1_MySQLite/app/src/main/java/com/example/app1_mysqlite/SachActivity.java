...
public class SachActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(dbHelper.themS(etMa.getText().toString(), etTen.getText().toString(), etMaTG.getText().toString())>0){
        ...
        btnSua.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(dbHelper.suaS(etMa.getText().toString(), etTen.getText().toString(), etMaTG.getText().toString())>0){
        ...
        btnXoa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(dbHelper.xoaS(etMa.getText().toString())>0){
...
//        arr = new ArrayList<>();
//        arr = dbHelper.TimS(ma);
//        for(sach s: arr){
//            arrayList.add(s.getMaSach());
//            arrayList.add(s.getTenSach());
//            arrayList.add(s.getMaTG());
//        }
